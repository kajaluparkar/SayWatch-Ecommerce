                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">
                                                <small class="text-muted">Price: ₹<%# Eval("watchprice") %></small><br />
                                                <strong><small class="text-muted">Dispatches By:<%#Eval("totalamount") %></small></strong>
                                            </p>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Button ID="ProceedToCheckoutButton" runat="server" Text="Proceed To Checkout" CssClass="btn btn-primary btn-block" OnClick="ProceedToCheckoutButton_Click" />
                        </div>
                    </div>
                </div>
            </div>
